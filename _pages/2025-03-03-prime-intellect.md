...
I’ve been designing for the web for over 15 years, starting with my own consultancy and evolving into an accomplished product designer and design engineer. Web UI and UX remain my deepest technical skillset, driving my fascination with crafting intuitive, high-performance digital experiences. At Amazon, I led design systems and front-end development within an engineering org, contributing production code to unify third-party deployments on Alexa. My ability to work closely with engineers and think systematically about interaction design gives me a natural edge in building scalable, fluid interfaces and compelling digital experiences.
